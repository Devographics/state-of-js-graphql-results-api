...
const projects = yaml.safeLoad(fs.readFileSync(path.resolve('./src/projects.yml'), 'utf8'));
const enums = yaml.safeLoad(fs.readFileSync(path.resolve('./src/enums.yml'), 'utf8'));
...
export const getEnum = type => enums[type] && enums[type].join('\n') || ''
